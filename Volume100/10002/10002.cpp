/*
 * Problem: "UVa10002 - Center of Masses"
 *  Author: "Jia_coding"
 *    Date: "2025/03/15"
 *     Tag: Geometry, Coordinates, Vector, Graham, center of mass
 *        : 幾何, 座標, 向量, Graham, 重心
**/
...
// 計算三個點的叉積
//crossproduct(P[0], b, c) > 0 表示 b 在 c 的逆時針方向
//crossproduct(P[0], b, c) < 0 表示 b 在 c 的順時針方向
//crossproduct(P[0], b, c) = 0 表示 b, c 共線
